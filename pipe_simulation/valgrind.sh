...
# valgrind -s -q --track-origins=yes --leak-check=full --track-fds=all --trace-children=yes ./one_pipe ls grep o
# echo
# echo
...
valgrind -s -q --trace-children=yes --leak-check=full ./multi_pipes ls -l "|" grep o "|" grep f "|" grep  t "|" wc -l 
#--track-fds=all
#--leak-check=full
#--log-file=output1
#--track-origins=yes
